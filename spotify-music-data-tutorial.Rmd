...
Feel free to click the link above and view the data dictionary which shows what kind of data (e.g. track_name, playlist_genre, energy) is in spotify_songs.
...
In the next part of the tutorial, we will learn how we can use data wrangling to learn more about this data!
