...
Kaya added: We added the step group_by(track_album_name), which does exactly what it sounds like: it groups by track_album_name before calculating summary statistics!
...
paak = spotify_songs %>%
  filter(track_artist == "Anderson .Paak") %>%
  select(track_name, track_album_name, playlist_name, playlist_genre, playlist_subgenre)
